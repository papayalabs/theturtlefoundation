...
ActiveRecord::Schema.define(version: 2021_12_05_134412) do
  ...
  create_table "comments", id: false, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb3", force: :cascade do |t|
  ...
  create_table "custom_fields", id: false, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb3", force: :cascade do |t|
    t.string "id", limit: 36
  ...
  create_table "custom_fields_relationships", id: false, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb3", force: :cascade do |t|
    t.string "id", limit: 36
    t.string "objectid"
  ...
  create_table "media", id: false, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb3", force: :cascade do |t|
    t.string "id", limit: 36
    t.string "site_id"
    t.string "name"
  ...
  create_table "metas", id: false, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb3", force: :cascade do |t|
    t.string "id", limit: 36
    t.string "key"
    t.text "value", limit: 4294967295
    t.string "objectid"
  ...
  create_table "plugins_contact_forms", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb3", force: :cascade do |t|
    t.integer "site_id"
    t.integer "count"
    t.integer "parent_id"
    t.string "name"
  ...
  create_table "posts", id: false, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb3", force: :cascade do |t|
    t.string "id", limit: 36
    t.text "title"
    t.text "slug"
    ...
    t.index ["slug"], name: "index_posts_on_slug", length: 255
    t.index ["status"], name: "index_posts_on_status"
    t.index ["user_id"], name: "index_posts_on_user_id"
  end

  create_table "term_relationships", id: false, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb3", force: :cascade do |t|
    t.string "id", limit: 36
    t.string "objectid"
    t.integer "term_order"
  ...
  create_table "term_taxonomy", id: false, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb3", force: :cascade do |t|
    t.string "id", limit: 36
    t.string "taxonomy"
  ...
  create_table "users", id: false, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb3", force: :cascade do |t|
    t.string "id", limit: 36
    t.string "username"
